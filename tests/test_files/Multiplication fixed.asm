...
.text
inputloop1:
  load KBD            #Lexing error - misspelled load
  mov m d
  load 0value
  subl m d
  load inputloop1
...
inputloop2:
  ...
  load 9
  add a d
  load input2          #Parsing Error - input2 not declared
  mov d m
...
#Calculate expected output
  mult_10_loop:             #Lexing error - no colon
    load loop_index
    mov m d
